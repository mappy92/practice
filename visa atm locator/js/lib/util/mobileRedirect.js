...
define( function () {
	...
	// this needs to take into account the actual url...
	var redirectUrl = 'mobile/index.jsp'+location.search+location.hash;
	...
	function InitDeviceScan()
	{
	    ...
	    if (isIphone || isAndroidPhone || isTierIphone || isTierRichCss || isTierGenericMobile) {
	    	redirectToMobile();
	    } else {
	    	return false;
			}
